    ...
    <main>
        ...
        <div class="tube">
            ...
            <ul bs-list="inline" class="">
                <li>
                    <a href="app/server-info.html" >Overview</a> <span bs-sep>|</span>
                </li>
                <li>
                    <a href="app/sync-options.html" >Sync Options</a> <span bs-sep>|</span>
                </li>
                <li>
                    <a href="app/history.html" >History</a> <span bs-sep>|</span>
                </li>
                <li>
                    <a href="app/plugins.html" >Plugins</a> <span bs-sep>|</span>
                </li>
                <li>
                    <a href="app/remote-debug.html" >Remote Debug</a> <span bs-sep>|</span>
                </li>
                <li>
                    <a href="app/network-throttle.html" >Network Throttle</a> <span bs-sep>|</span>
                </li>
                <li>
                    <a href="app/help.html" >Help / About</a> 
                </li>
            </ul>
            <hr/>
        </div>
